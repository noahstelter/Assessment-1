...
const design = "The design stage is a necessary precursor to the main developer stage. Developers will first outline the details for the overall application"
...
const implementation = "After testing, the overall design for the software will come together. The information system will be integrated into its environment and eventually installed."
const maintain = "Developers must now move into a maintenance mode and begin practicing any activities required to handle issues reported by end-users. Developers are responsible for implementing any changes that the software might need after deployment."